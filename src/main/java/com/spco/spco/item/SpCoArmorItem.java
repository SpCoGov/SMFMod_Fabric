...
public class SpCoArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(SpCoArmorMaterials.WENTAO,
                            new StatusEffectInstance(StatusEffects.LUCK, 20, 1, true, false)).build();

    public SpCoArmorItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
    ...
    private void addStatusEffectForMaterial(PlayerEntity player, ArmorMaterial mapArmorMaterial, StatusEffectInstance mapStatusEffect) {
        ...
        if (hasCorrectArmorOn(mapArmorMaterial, player) && !hasPlayerEffect) {
            ...
            player.addStatusEffect(new StatusEffectInstance(StatusEffects.NIGHT_VISION, 300, 1, true, false, false));
